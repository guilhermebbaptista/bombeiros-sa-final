...
--
-- Host: 127.0.0.1:3307
-- Tempo de geração: 17-Nov-2023 às 14:32
...
--
-- Estrutura da tabela `anamnese_emerg`
--
...
--
-- Estrutura da tabela `anamnese_gest`
--
...
--
-- Estrutura da tabela `deixados_hospital`
--
...
--
-- Estrutura da tabela `equipe_atendimento`
--
...
--
-- Extraindo dados da tabela `equipe_atendimento`
--

INSERT INTO `equipe_atendimento` (`id_equipe`, `equipe`, `senha`) VALUES
(1, '', ''),
(2, '123', 'senha123');
...
--
-- Estrutura da tabela `info_finais`
--
...
--
-- Estrutura da tabela `localiza_trauma`
--
...
--
-- Estrutura da tabela `problem_suspeito`
--
...
--
-- Estrutura da tabela `proced_efetuados`
--
...
--
-- Estrutura da tabela `user_detalhes`
--
...
--
-- Índices para tabela `anamnese_emerg`
--
ALTER TABLE `anamnese_emerg`
  ADD PRIMARY KEY (`id_anamnese_emerg`);

--
-- Índices para tabela `anamnese_gest`
--
...
--
-- Índices para tabela `deixados_hospital`
--
ALTER TABLE `deixados_hospital`
  ADD PRIMARY KEY (`id_deixados_hospital`);

--
-- Índices para tabela `equipe_atendimento`
--
ALTER TABLE `equipe_atendimento`
  ADD PRIMARY KEY (`id_equipe`);

--
-- Índices para tabela `info_finais`
--
ALTER TABLE `info_finais`
  ADD PRIMARY KEY (`id_info_finais`);

--
-- Índices para tabela `localiza_trauma`
--
...
ALTER TABLE `paciente`
  ...
  ADD KEY `fk_deixados_hospital2` (`fk_deixados_hospital`);

--
-- Índices para tabela `problem_suspeito`
--
ALTER TABLE `problem_suspeito`
  ADD PRIMARY KEY (`id_problem_suspeito`);

--
-- Índices para tabela `proced_efetuados`
--
...
--
-- Índices para tabela `user_detalhes`
--
...
--
-- AUTO_INCREMENT de tabela `equipe_atendimento`
--
ALTER TABLE `equipe_atendimento`
...
ALTER TABLE `paciente`
  ...
  ADD CONSTRAINT `fk_deixados_hospital2` FOREIGN KEY (`fk_deixados_hospital`) REFERENCES `deixados_hospital` (`id_deixados_hospital`),
...
--
-- Limitadores para a tabela `user_detalhes`
--
ALTER TABLE `user_detalhes`
